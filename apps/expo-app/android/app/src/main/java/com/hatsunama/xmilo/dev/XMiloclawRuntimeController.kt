...
object XMiloclawRuntimeController {
  ...
  fun snapshot(context: Context): XMiloclawRuntimeStatus {
    ...
    val status =
      ...
      hostReady = hostReady,
      llmMode = XMiloclawSidecarProcessController.lastReadyLlmMode(),
      byokProvider = XMiloclawSidecarProcessController.lastReadyByokProvider(),
      subscriptionEntitled = XMiloclawSidecarProcessController.lastReadySubscriptionEntitled(),
      bringYourOwnKeyActive = XMiloclawSidecarProcessController.lastReadyBringYourOwnKeyActive(),
      phase9ApiKeyAccess = XMiloclawSidecarProcessController.lastReadyPhase9ApiKeyAccess(),
      firstTaskEligible = XMiloclawSidecarProcessController.lastReadyFirstTaskEligible(),
      relayLlmTurnAllowed = XMiloclawSidecarProcessController.lastReadyRelayLlmTurnAllowed(),
      localLlmTurnAllowed = XMiloclawSidecarProcessController.lastReadyLocalLlmTurnAllowed(),
