...
5. Confirm xMilo Sidecar SQLite schema is at current version, run migrations if needed
6. Read xMilo Sidecar SQLite — active task (canonical live source)
7. Read xMilo Sidecar SQLite — queued task (canonical live source)
...
xMilo Sidecar SQLite is the canonical live source after migration.
