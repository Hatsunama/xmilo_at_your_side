# xMilo Sidecar Go — Implementation Responsibility Checklist

**Authority:** xMilo Mind Merge Spec v1 + Lair spec packs v1–v19
**Purpose:** Complete inventory of everything xMilo Sidecar Go must implement. Use this to prevent drift during development.
...
- [ ] 10-minute inactivity timer owned by xMilo Sidecar
...
- [ ] On app reconnect after JWT expiry: app calls relay /session/start, then xMilo Sidecar /auth/refresh
