...
- update the resumable state in PicoClaw SQLite (canonical)
...
Conversation tail lives in PicoClaw SQLite exclusively.
PicoClaw trims it to the last 12 turns or ~4000 input tokens, whichever is smaller.
