...
- app shows access choices inline based on launch mode:
  - launch `code_only`: redeem access code
  - later public mode: start free trial / redeem code / subscribe
- if trial is not enabled yet, do not show that slot prematurely
...
- grant the configured access window, currently 30 days during launch
