...
type NightlyMaintenanceDeferred struct {
...
type NightlyMaintenanceStarted struct {
	ArchiveDate       string `json:"archive_date"`
	...
	UpdateCheckStatus string `json:"update_check_status"`
	VoiceCue          string `json:"voice_cue"`
	PhysicalCue       string `json:"physical_cue"`
}

type NightlyMaintenanceCompleted struct {
	ArchiveDate       string `json:"archive_date"`
	Trigger           string `json:"trigger"`
